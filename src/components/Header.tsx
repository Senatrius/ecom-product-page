    ...
    <header className='relative w-full'>
      ...
      {isCartOpen && (
        <div className='absolute right-[2%] z-30 mt-2 w-[96%] max-w-[22.5rem] rounded-lg bg-white shadow-xl lg:right-[6.25%]'>
          ...
          <div className='flex min-h-[11.75rem] flex-col justify-center px-6 pt-6 pb-8'>
            {products === 0 ? (
              ...
              <>
                ...
                <button className='rounded-md bg-primary-orange p-5 text-button text-white hover:bg-primary-orange-hover focus:bg-primary-orange-hover'>
                  Checkout
                </button>
              </>
            )}
